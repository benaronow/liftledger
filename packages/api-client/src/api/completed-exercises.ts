...
// — Pure helper functions over the completedExercises response —
// Lifted out of CompletedExercisesProvider so consumers can call them without
// going through a React context. Pass the data in from useCompletedExercises().
