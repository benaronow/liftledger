import { createUser, deleteUser, getAllUsers, selectUsers } from "@/lib/features/user/userSlice";
...
export const FitnessLog = ({ socket }: { socket: FitnessLogSocket | null }) => {
    ...
    return (
        <>
            ...
            <input value={removeUsername} onChange={handleRemoveUsernameChange}></input>
