...
import { COLORS, Exercise } from "@liftledger/shared";
      ...
      {exercises?.map((exercise, idx) => (
        ...
        >
          ...
          <View style={styles.card}>
            ...
            >
              {exercise.addedOn && (
                <Text style={styles.addonBadge}>ADD-ON</Text>
              )}
              ...
              <View style={styles.cardTitle}>
                ...
                <Text style={styles.titleText}>{exercise.apparatus}</Text>
              </View>
            </View>
            {!isEditing && (
              <SetList
...
const styles = StyleSheet.create({
  ...
  cardWrap: { width: "100%", alignItems: "center", gap: SPACING.sm },
  card: {
    width: "100%",
  ...
  titleText: { color: "white", fontWeight: "600", fontSize: FONT.base },
});
